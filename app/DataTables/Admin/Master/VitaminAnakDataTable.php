...
class VitaminAnakDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\App\Models\admin\anak\VitaminAnak $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(VitaminAnak $model)
    {
