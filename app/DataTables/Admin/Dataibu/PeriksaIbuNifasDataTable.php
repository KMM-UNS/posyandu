...
class PeriksaIbuNifasDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\App\Models\Admin\Dataibu\PeriksaIbuNifasDataTable $model
    ...
    {
        return $this->builder()
            ->setTableId('periksa_ibu_nifas-table')
    ...
    {
        return 'Admin\Dataibu\PeriksaIbuNifas_' . date('YmdHis');
    }
}
