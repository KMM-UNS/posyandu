...
@section('content')
    ...
    <form
        ...
        <div class="row">
            <div class="col-xl-6 ui-sortable">
                ...
                <div class="panel panel-inverse">
                    ...
                    <button class="btn btn-info btn-primary" data-toggle="modal" data-target="#caraform"><i
                            class="fa fa-info-circle"></i> Cara Pengisian Form</button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    Tulis identitas lengkap usia lanjut pemilik KMS. Lalu ukur tinggi badan dalam centimeter
                                    tanpa alas kaki dalam keadaan berdiri tegak dan catatlah hasil pengukuran di tempat yang
                                    tersedia.<br>
                                    <br><b>3. Kegiatan hidup sehari-hari</b><br>
                                    a. Tanyakan kepada usia lanjut atau keluarganya, apakah usia lajut masih mampu melakukan
                                    kegiatan sehari-hari tanpa bantuan sama sekali? <b>( mandiri = kategori C ) </b><br>
                                    b. Ataukah ada gangguan dalam melakukan kativitas sendiri, hingga kadang-kadang perlu
                                    bantuan ? <b> ( ada gangguan = kategori B) </b> <br>
                                    c. Ataukah sama sekali tidak mampu melakukan kegiatan sehari-hari, sehingga sangat
                                    tergantung dengan orang lain? <b>(ketergantungan = kategori A )</b> <br>
                                    d. yang dimaksud dengan kehidupan sehari-hari adalah kegiatan dasar dalam kebidupan,
                                    seperti : makan, minum, berjalan, mandi berpakaian, naik turun tempat tidur, buang aii
                                    besar atau buang air kecil dan sebagainya. <br>
                                    e. Kegiatan pekerjan di luar rumah, seperti berbelanja, mencari nafkah, mengambil
                                    pensiun, arisan, pengajian dll. <br>
                                    f. Pilih pada hasil yang sesuai <b>(mandiri (Kategori C), ada gangguan (Kategori B),
                                        ketergantungan (Kategori A))</b> <br>
                                    ...
                                    - Sikap ramah dan penuh perhatian akan kebutuhan usia lanjut secara menyeluruh sehingga
                                    mempermudah hubungan yang terbuka dan lancar antara usia lanjut dengan
                                    petugas/kader.<br>
                                    ...
                                    Kurus : <b>
                                        < 18,5 </b> <br>
                                            ...
                                            • Ukur tekanan darah dengan tensimeter dan stetoskop. Catat angka sistole dan
                                            diastole pada kolom yang tersedia. Cocokkan dengn nilai normalnya, yaitu sistole
                                            antara 120-16c mmHg dan diastole 90 mmHg atau kurang. <br>
                                            • Apabila salah saru sistole atau diastole atau keduanya di atas normal, maka
                                            masuk kriteria tinggi <br>
                                            • Apabila sistole dan diastolenya di bwah normal, maka masuk kriteria rendah
                                            <br>
                                            <br><b>7. Hemoglobin</b><br>
                                            • Periksa Hb dengan salah satu cara, yaitu talquist, sahli, atau cupri sulfat
                                            <br>
                                            • Catatlah hasilnya pada kolom yang tersedia. Tanda % apabila memakai cara
                                            talquist, 13 g % untuk pria dan 12 g% untuk wanita bila menggunakan cara sahli
                                            atau cupri sulafat <br>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <x-form.Dropdown name="nama_lansia1" :options="$nama_lansia"
                                selected="{{ old('nama_lansia1') ?? ($data['nama_lansia1'] ?? null) }}" required />
        ...
        <input type="radio" id="kategori_c" name="kategori_c"  value="{{ $data->kategori_c ?? old('kategori_c') }}"> Kategori C --}}
                            ...
                            <input type="text" id="indeks_massa_tubuh" name="indeks_massa_tubuh" class="form-control"
                                autofocus data-parsley-required="false" onkeyup="hitung();"
                                value="{{ $data->indeks_massa_tubuh ?? old('indeks_massa_tubuh') }}">
                            <label for="name">Tekanan Darah</label>
                            <input type="text" id="tekanan_darah" name="tekanan_darah" class="form-control" autofocus
                                data-parsley-required="true" value="{{ $data->tekanan_darah ?? old('tekanan_darah') }}">
                            <label for="name">Hemoglobin</label>
                            <input type="text" id="hemoglobin" name="hemoglobin" class="form-control" autofocus
                                data-parsley-required="true" value="{{ $data->hemoglobin ?? old('hemoglobin') }}">
                            <label for="name">Reduksi Urine</label>
                            <input type="text" id="reduksi_urine" name="reduksi_urine" class="form-control" autofocus
                                data-parsley-required="true" value="{{ $data->reduksi_urine ?? old('reduksi_urine') }}">
                            <label for="name">Protein Urine</label>
                            <input type="text" id="protein_urine" name="protein_urine" class="form-control" autofocus
                                data-parsley-required="true" value="{{ $data->protein_urine ?? old('protein_urine') }}">
                        </div>
                    </div>
