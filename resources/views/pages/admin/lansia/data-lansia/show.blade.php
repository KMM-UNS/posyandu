        ...
        <div class="row mx-auto">
            <div class="col-md-6">
                ...
                <div>
                    ...
                    <p class="font-weight-bold">{{ $data->jaminankesehatan->jaminan_kesehatan_id }}</p>
                </div>
                <div>
                    <label>No HP</label>
                    <p class="font-weight-bold">{{ $data['no_hp'] }}</p>
                </div>
                <a class="btn btn-secondary" href="/admin/data-lansia/datalansia/2/edit" role="button">Edit Data</a>
