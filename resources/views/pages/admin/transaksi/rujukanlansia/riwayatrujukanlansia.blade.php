...
<div class="panel panel-inverse">
  ...
  <div class="panel panel-inverse">
    <div class="panel-body">
      <center><h4> Laporan Data Rujukan Lansia</h4></center>
      <a href="/admin/data-transaksi/cetakriwayatrujukan/{{ session('data')->first()->rujukan->id }}" class="btn btn-secondary btn-sm float-right mr-4"><i class="fa fa-print fa-fw"></i> Cetak Laporan </a>
      <br>
