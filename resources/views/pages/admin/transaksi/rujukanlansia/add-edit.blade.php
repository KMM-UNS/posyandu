...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.data-transaksi.rujukanlansia.update', $data->id) : route('admin.data-transaksi.rujukanlansia.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
    @csrf
    @if(isset($data))
    {{ method_field('PUT') }}
    @endif
