...
@section('title', isset($data) ? 'Edit Jenis Vaksin' : 'Create Jenis Vaksin' )
...
<!-- begin panel -->
<form action="{{ isset($data) ? route('admin.master-data.jenisvaksin.update', $data->id) : route('admin.master-data.jenisvaksin.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
