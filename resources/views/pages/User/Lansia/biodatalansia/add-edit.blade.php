...
<!-- begin panel -->
<form action="{{ isset($data) ? route('userlansia.biodatalansia.update', $data->id) : route('userlansia.biodatalansia.store') }}" id="form" name="form" method="POST" data-parsley-validate="true">
  @csrf
  @if(isset($data))
  {{ method_field('PUT') }}
  @endif
